...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jun 01, 2019 at 11:43 PM
...
INSERT INTO `admin` (`user_id`, `user_fname`, `user_lname`, `user_email`, `user_password`, `user_type`, `email_confirmed`, `token`) VALUES
(32, 'admin', 'admin', 'admin@email.com', '$2y$10$G3Q6Bgn14hx77MFV5baVSemmXOAF.hwXBkx9uKvbDPNssG0NO6dG6', 'user', 1, ''),
(33, 'test', 'one', 'testone@email.com', '$2y$10$BkaUoXQiN14oxmgNGjAnGeOkTZWOiMfMJwPGP3r5K4C5SNyf.j9fa', 'user', 0, 'FEIZtQkAu0'),
(34, 'test', 'two', 'testtwo@email.com', '$2y$10$Q5WIrRlFojnS2KmVEZbJ4uMgYz213miBalO0qCLDb3bIyjM2Ftbz.', 'user', 1, '');
...
(30, 'new', 'user', 'newuser@email.com', '$2y$10$/VliAndSEWvwIxhwhvJswOr8jft9mGKClU5Q/zV4OIMylqG22BR5e', 'user', 0, 'f9UMq$tOaw');
COMMIT;
