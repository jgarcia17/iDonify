	...
	<div class="content">
		...
		<?php  if (isset($_SESSION['username'])) : ?>
			...
			<form method="post" action="server.php" style="width: 100%;">
				...
				<div class="input-group">
					<label>Phone</label>
					<input type="checkbox" name="v_phone" style="position: relative; top: -30px;">
				</div>
				

				<div class="input-group" >
					<label>Repairing devices?</label>
					<input type="checkbox" name="v_repair" style="position: relative; top: -30px;">
				</div>
				

				<div class="input-group">
					<label>Entering data</label>
					<input type="checkbox" name="v_enter" style="position: relative; top: -30px;">
				</div>
